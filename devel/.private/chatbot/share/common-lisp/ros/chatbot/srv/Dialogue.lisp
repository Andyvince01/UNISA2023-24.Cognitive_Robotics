...
(cl:defmethod input_text-val ((m <Dialogue-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatbot-srv:input_text-val is deprecated.  Use chatbot-srv:input_text instead.")
  (input_text m))
...
(cl:defmethod answer-val ((m <Dialogue-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chatbot-srv:answer-val is deprecated.  Use chatbot-srv:answer instead.")
  (answer m))
